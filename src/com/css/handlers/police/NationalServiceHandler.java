...
public class NationalServiceHandler extends BaseHandler{
    ...
    public void insertLogs(ClientInfo client, String sfzh, String xml){
        ...
        String insertSql2 = "insert into ZL_POLICE_LOG(SN, LOGINNAME, NAME, USERID, IP, DB, SFZH, cjsj, scbj, jg, CONTENT, LB)"
                +" values(sys_guid(), '"+client.getLoginname()+"', '"+client.getUsername()+"', '"+client.getUserid()+"', '"+client.getIp()+"', '"+client.getDb()+"', '"+sfzh+"', sysdate, '0', '"+jg+"', '"+xml+"','1')";
        JDBCUtils.execute(insertSql2);
    }

    private String getCondition(String sfzh) {
